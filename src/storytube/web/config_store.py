...
CONFIG_SCHEMA: list[dict[str, Any]] = [
    ...
    },
    {
        ...
        "type": "password",
        "secret": True,
        "help": "From a Desktop-type OAuth client. Needed to connect your channel for uploads and analytics.",
        "guidance": "Google Cloud Console \u2192 APIs & Services \u2192 Credentials \u2192 Create Credentials \u2192 OAuth client ID \u2192 Desktop app.",
        "guidance_url": "https://console.cloud.google.com/apis/credentials",
    },
    {
        ...
        "type": "password",
        "secret": True,
        "help": "Issued alongside the Client ID for the same OAuth client.",
        "guidance": "",
        "guidance_url": "",
    },
    {
        ...
        "secret": True,
        "hidden": True,
        "help": "Written automatically by the Connect YouTube button. Not something you type in by hand.",
        "guidance": "",
        "guidance_url": "",
    },
    {
        ...
        "type": "password",
        "secret": True,
        "help": "Optional. Used only to look up public channel stats without needing to connect.",
        "guidance": "Google Cloud Console \u2192 APIs & Services \u2192 Credentials \u2192 Create Credentials \u2192 API key.",
        "guidance_url": "https://console.cloud.google.com/apis/credentials",
    },
    {
        ...
        "secret": False,
        "hidden": True,
        "help": "Written automatically once you connect.",
        "guidance": "",
        "guidance_url": "",
    },
    {
